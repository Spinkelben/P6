...
\note{
    ...
    \item \textbf{Ingen autoritet}. Vi kan ikke \textbf{fyre }grupper
...
\note{
  \begin{itemize}
    \item Før havde vi ikke en fast måde at skrive backlog items på.
    \item Revidering:
...
\begin{frame}
    \note{
      \begin{itemize}
        ...
        \end{itemize}
        \item Product owner: \textbf{kende kundernes behov}, kontakt med kunder.
        \begin{itemize}
          \item Vi overvejde strukturen af i Scrum-of-Scrums.
          \item valgt \textbf{Løsning}: Et subprojekt har egen product owner, kunde og backlog.
...
\begin{frame}
    ...
    \begin{itemize}
      ...
      \item Automatisk bygning og testning af apps og biblioteker
...
\note{
    ...
    \item Derfor giver det mening at indføre CI.
    \item CI understøtter mange af de ting vi ønsker at gøre.
    \item[]
    \item Dette er en afvigelse fra almindelig Scrum i og med vi har 3 product owners.
	\end{itemize}
}
