...
In connection with specifying the development method, \group{1} approaches us with some feedback on the development method. They have made an analysis of some aspects of the multi-project where they feel the development method is not appropriate \cite{processanalysis}\todo{Hvordan refererer vi til dette?}. The main points are: \todo{Jeg synes der mangler lidt mere argumentation i følgende liste:}
\begin{description}
