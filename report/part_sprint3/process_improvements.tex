...
In connection with specifying the development method, \group{1} approaches us with some feedback on the development method. They have made an analysis of some aspects of the multi-project where they feel the development method is not appropriate \cite{processanalysis}\todo{Indsæt som appendix} The main points are:
\begin{description}
