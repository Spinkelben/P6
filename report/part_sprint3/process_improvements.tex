...
In connection with specifying the development method, \group{1} approached us with some feedback. They had made an analysis of some aspects of the multi-project where they felt the development method was not appropriate\todo{Hvordan refererer vi til dette?}. The main points are:
