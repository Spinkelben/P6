...
We succeed in accomplishing all user stories this sprint, but miss a non-crucial task. In this chapter we evaluates the tasks we planned to do and the sprint as a whole on a multi-project level.
