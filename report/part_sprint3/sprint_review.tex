...
\begin{description}
  ...
  \item[Specify the Scrum process used (4)] \group{1} approached us last sprint with an analysis of the development method. The analysis raised a number of critiques, which we discuss with \group{1}. From this discussion we, in collaboration with \group{1}, revise the development method. We specify how user stories are formulated, and add new types of product backlog items.
\end{description}
