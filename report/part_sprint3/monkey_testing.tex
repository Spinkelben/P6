...
To make monkey testing work, we make a simple app that inserts dummy database into a database. In addition all Giraf apps have to modified so that they accept a monkey test and uses the dummy data inserted into the database.
