...
We have tried implementing monkey testing in the two previous sprints. In this sprint we succeed in setting up monkey testing for all GIRAF apps.\todo{Ny intro}
