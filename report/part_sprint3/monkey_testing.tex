...
To make monkey testing work, we make a simple app that inserts dummy data into the local database. In addition, all Giraf apps have to be modified so that they accept a monkey test and use the dummy data inserted into the database.
