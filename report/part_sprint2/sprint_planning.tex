...
\begin{table}%
  ...
  \begin{tabular}{p{0.6\textwidth}rr}
    ...
    \bottomrule
  \end{tabular}
\caption{Sprint backlog for sprint 1 TODO: 2?, excluding report tasks. The tasks are listed in no particular order.}
