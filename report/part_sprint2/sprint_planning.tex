...
\kimnote{I think that you should go into detail of how you planned their meeting and how your plan made sure that there was no irrelevant discussions and that the backlog was at at fitting abstraction level .}
...
\begin{description}
  \item[Auto Upload Alpha and Beta Releases of Apps (1)] Apps should automatically be uploaded to Google Play when they build successfully to an alpha channel. They should be able to be uploaded to a beta channel when the decision is made. \kimnote{What decision? }
...
\end{table}
\kimnote{What does estimations with parenthesis mean? e.g. 6 (1)? }