...
\end{description}
Each of the three repository systems comply with these requirements. As such, it does not really matter which system we choose. We choose to use Artifactory because it has a plugin for Jenkins which may be useful for future projects.
...
% Beskriv evt workflow (major, minor osv)