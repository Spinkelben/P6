...
\begin{pythoncode}[float=tbp,caption=Part of the Git hook responsible for setting library version names and triggering Jenkins,label=lst:git_hook_trigger_build]
