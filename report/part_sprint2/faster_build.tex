...
By hosting our own internal artifact repository for our libraries, we are able to declare the dependencies in the build-file, and at the same time remove Git submodules and make builds happen faster. Different pieces of software for hosting repositories exist, which we will present in this section.
