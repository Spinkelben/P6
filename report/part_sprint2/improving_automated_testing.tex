...
The APK with the highest build number is the newest. Running the script in \listingref{lst:find_newest_apk} with the application id \code{dk.aau.cs.giraf.launcher} will find the apk \code{dk.aau.cs.giraf.launcher\_v2.3b21\_release\_aligned.apk}. \todo{Nyt læs}
