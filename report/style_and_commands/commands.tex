...
% Custom styling commands.
  ...
  % Dummy line.
  \newcommand{\dummy}{Lorem ipsum dolor sit amet, consectetur adipiscing elit.}
...
% Document structure.
  ...
  \newenvironment{chapterorganization}{\vspace{.5cm}\noindent\textbf{Chapter Organization}\quad The remainder of this chapter is organized in the following fashion:\begin{itemize}}{\end{itemize}}
