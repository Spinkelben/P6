...
\begin{figure}%
  ...
  \end{tikzpicture}
  \caption[Some short text]{Some long text.}%
...
\section{Evaluation of Build Times}
\dummy
...
\begin{tikzpicture}[]
  ...
  \end{axis}
\end{tikzpicture}
\caption{Comparison of Launcher timings}\label{fig:launcher_build_times_3}
\end{figure}