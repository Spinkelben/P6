...
\begin{chapterorganization}
  \item in \sectionref{sec:selecting_nonemu_method} we ;
  \item in \sectionref{sec:pool_of_tablets} we ;
  \item in \sectionref{sec:router_server_tablet} we ;
  \item in \sectionref{sec:wireless_adb} we ;
  \item in \sectionref{sec:jenkins_physical_devices} we ;
  \item in \sectionref{sec:adapting_job_flow} we ;
