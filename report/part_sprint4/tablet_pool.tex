...
\begin{javacode}[float=tb,label=lst:android_app_shell,caption=Enable wireless ADB in Android (written in Java)]
...
\begin{javacode}[float=tb,label=lst:android_app_broadcast_receiver,caption=Android boot broadcast receiver (written in Java)]
...
\begin{javacode}[float=tb, caption=The devicesConnected method which checks for connected devices (written in Java),label=lst:deviceCheck]
...
\begin{lstlisting}[language=bash,caption=Bash script that connects to devices,label=lst:connect_devices]
...
\begin{lstlisting}[language=bash,caption=Bash script that uninstalls all installed GIRAF apps on all devices,label=lst:uninstall_apks]
uninstall() {
...
\begin{lstlisting}[language=bash,caption=Bash script that gets the serial numbers of all connected devices,label=lst:get_serial_numbers]
...
\begin{lstlisting}[language=bash,caption=Bash script that disconnects all connected devices,label=lst:disconnect_devices]
