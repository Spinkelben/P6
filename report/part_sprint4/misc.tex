...
Next year the development of the multi-project will be taken over by the current 4\textsuperscript{th} semester software students. To ease the handover of the project we describe the Jenkins configuration, and installation in a complete reference document. The document can be seen in \appendixref{app:jenkins_structure}. The document is an attempt to formalize all of our tacit knowledge of the Jenkins server in a complete record. 