...
We give all libraries priority two by default, and all apps priority four. The \emph{Meta-database} library, however, has priority one, as the developers often wait for this specific library to complete.
