...
In the previous sprint we specified the backlog items used in the multi-project and how to formulate user stories (see \sectionref{sec:processspecs}). This specification is followed this sprint.
