...
\begin{description}
  ...
  \begin{itemize}
    \item Document how to configure Jenkins jobs
...
\begin{description}
  \item[(6) Decrease Job Build Times in Jenkins] When the queue in Jenkins is long, jobs can take a very long time to build. As we discussed in \sectionref{sec:non-emulator_testing}, the build times can be further reduced by working on the emulator part.
\end{description}
