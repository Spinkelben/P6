...
\begin{description}
  ...
  \end{itemize}
  \item[(4)] As a future developer I want to know what is in Jenkins and how it is structured so that it it\kimnote{no double words, this is not rap music! ;)} is easy to start working with \kimnote{with what?, maybe "it"}
  \begin{itemize}
