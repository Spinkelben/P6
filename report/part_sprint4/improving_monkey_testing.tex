...
\begin{lstlisting}[language=bash,showstringspaces=false,caption=Bash script that moves the debug APK to the ftp server,label=lst:move_debug_apk]
#!/bin/bash
...
\begin{lstlisting}[language=bash,caption=Bash script that runs monkey tests on all connected devices in parallel,label=lst:run_monkey_parallel]
#!/bin/bash
