...
\begin{description}
  ...
  \item[Weighted Fair Queuing] Each priority gets a fraction of the total throughput. The higher priority, the larger the fraction. \todo{Describe this a bit more}
\end{description}
