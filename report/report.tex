...
\input{frontmatter/preface.tex} % The empty line below must be there!
...
\input{part_sprint1/swdev_method} %path represents old structure, i was too lazy to fix.
\sprint{Software Development Method and Configuration Management}
...
\bookmarksetup{startatroot} % To end the parts.
