...
\begin{gradlecode}[caption=Gradle Plugin to help publish APKs,label=lst:gradle_plugin_publish_app]
...
\begin{gradlecode}[caption=Gradle Plugin to publish libraries,label=lst:gradle_plugin_library_app]
package dk.giraf.gradle
