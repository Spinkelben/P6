...
Each group decides how to manage their internal affairs. As long as they produce the required artifacts, they can decide for themselves how to organize. \todo{Check fiexed reformulateion}.

Since there are three product owners in the multi-project, three sprint ends and three sprint planning meetings are held between sprints\todo{reformulate Check}. These meetings were proposed by us, following the recommendation from \textcite{bird_davies_2007}, and afterwards approved by the other groups.
...
\begin{description}
  ...
  \begin{description}
    ...
    \item[\db and \bd] \db and \bd each hold a separate sprint end meeting where they show the groups in the other sub-projects what they have done in a sprint. The external customers are not present at these meetings, so that they are not bored with internal details.
  \end{description}
\end{description}
