...
\begin{description}
  ...
  This template is used for user stories in the multi-project. If the user story comes from a developer, the source of the user story should be noted in case there are questions about it. Because bugs are also in the users' interest to be fixed, bugs are also user stories \parencite{product-backlog2015}. 
