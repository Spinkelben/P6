%!TEX root = ../report.tex
\kimnote{Jeg har bemærket at i ikke lavet newline efter punktum i jeres latex code. Min erfaring er at ved at gøre dette undgår man mange konfliker fordi det bliver nemmer for git at auto merge}
...
\begin{documentorganization}
  ...
  \begin{itemize}
    ...
    \kimnote{Hvordan er dette relateret til det første sprint? Jeg kan ikke se hvorfor det skal ligge under sprint 1!}
