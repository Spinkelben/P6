...
While the Android monkey tool can test multiple applications at once, the Jenkins plugin does not support that feature. The plugin is open source, so we add support for this feature\kimnote{Again please do not leave out the details. Some me code, considerations, design, etc.}.
