...
\begin{lstlisting}[language=bash,showstringspaces=false,caption=Post-receive Git hook bash script that starts a job on Jenkins upon a push to a Git repository,label=lst:hook_script_first]
#!/bin/bash
