...
\begin{chapterorganization}
  \item in \sectionref{sec:project_overview} we describe how the multi-project is organized and introduce the levels in the project;
  \item in \sectionref{sec:responsibilities} we something something;
  \item in \sectionref{sec:redmine} we something something.
...
\todo{Skriv om at vi bruger fysiske tasks fordi redmine er for sløvt. Det er også okay at bruge, fordi alle grupper alligevel ikke kører scrum, og derfor kan vi ikke lave et samlet burn down.}
\todo{Vi bruger burn down chart}
