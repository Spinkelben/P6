...
The multi-project consists of 14 groups of approximately 4 people each. \kimnote{Normalt skriver man tal under 10 med bogstaver. :) }
...
In our group we use a \emph{burn down chart} \kimnote{Jeg kan godt lide at i bruger emph første gang i nævnet relevant fagterminilogi} to measure our progress. We would have liked to have this for the entire multi-project as well, but since not every group follows Scrum and makes estimated tasks, it is impossible to measure the performance of the multi-project, and as such it does not make sense to do a burn down chart for the entire multi-project.
