...
\begin{chapterorganization}
  \item in \sectionref{sec:s1_goals} we \todo{fill out};
  \item in \sectionref{sec:s1_processeval} we \todo{fill out};
  \item in \sectionref{sec:s1_multiprj_review} we \todo{fill out}.
\end{chapterorganization}

\section{Sprint Goals}\label{sec:s1_goals}
